...
// เก็บ HTML Template ของแต่ละส่วน (View Layer)
...
export const renderSettingsCard = () => `
    <section class="bg-white p-6 rounded-lg shadow-lg mb-6">
        ...
        <div class="space-y-4">
            ...
            <div class="hidden" id="bkk_zone_container"><label class="block text-sm font-medium text-slate-600">เลือกโซนในกรุงเทพฯ</label><select class="form-input mt-1 block w-full" id="bkk_zone_selector"><option value="BKK_Zone1_CBD">โซน 1: Core CBD</option><option value="BKK_Zone2_Transit">โซน 2: Transit Hub</option><option value="BKK_Zone3_Industrial">โซน 3: Industrial</option><option value="BKK_Zone4_MidTier">โซน 4: Mid-Tier</option><option selected="" value="BKK_Zone5_Suburban">โซน 5: Suburban</option></select></div>
